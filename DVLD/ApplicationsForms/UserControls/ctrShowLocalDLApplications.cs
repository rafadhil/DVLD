...

{
    public partial class ctrShowLocalDLApplications : UserControl
    {
        ...
        private void issueDrvingLicenseFirstTimeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form Frm = new FrmIssueDrivingLicenseFirstTime(GetApplicationSelectedFromDGV());
            Frm.ShowDialog();
            RefreshDGV();
        }
        ...
        {
            BusinessLayer.License LicenseInfo = BusinessLayer.License.GetLicenseByApplicationID(GetApplicationSelectedFromDGV().OriginalApplicationInfo.ApplicationID);
            Form Frm = new FrmShowLicenseInfo(LicenseInfo);
            Frm.ShowDialog();
        }

        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form frm = new FrmShowPersonLicenseHistory(GetApplicationSelectedFromDGV().OriginalApplicationInfo.ApplicantInfo);
            frm.ShowDialog();
